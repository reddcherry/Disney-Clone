The skeleton HTML and CSS (Only HTML and CSS) are built with the help of the Clever programmer's youtube video, to which react functionalities are added upon. 
